...
?>
  <div class="removeuser">
    <a href="http://localhost/finalchat1/removeusers.php?room=<?php echo $room?>" title="Remove User"><i class="fa fa-user-times" style="font-size:20px;float: right;color:#000"></i></a>
  </div>
<?php
  }
?>
